...
export default [
  <Route path='/users/create' component={userIsAdminRedir(Create)} exact={true} key='create'/>,
  <Route path='/users/edit/:id' component={userIsAdminRedir(Update)} exact={true} key='update'/>,
