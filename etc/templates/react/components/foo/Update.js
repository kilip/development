...
class Update extends Component {
    componentDidMount() {
        this.props.retrieve('/{{{ lc }}}s/'+this.props.match.params.id);
    }
    ...
    render() {
        if (this.props.deleted) return <Redirect to="/{{{ name }}}"/>;
        ...
        return (
            <div>
              ...
              <Link to="/{{{ name }}}" className="btn btn-primary">Back to list</Link>
